...
public class PersonalNoteController {
	...
	@DeleteMapping("/delete/{noteTitile}")
	public ResponseEntity<?> deleteNotes(@PathVariable("noteTitile") String noteTitile) throws Exception {
		personalNoteService.deleteByNoteTitle(noteTitile);
